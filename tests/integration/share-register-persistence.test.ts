...
describe("SQLite application repositories", () => {
  ...
  test("normalizes shareholder identifiers and enforces company-scoped uniqueness", () => {
    withDatabase((database) => {
      ...
      expect(alice.identifierValue).toBe("8112182392");
      expect(() =>
        createShareholder(
          database,
          {
